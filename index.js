...
const config = {
    A187:📍FELIPE GOSTOSO📍
    instagram: https://www.instagram.com/_felima0/
    nomer: https://wa.me/558182133322
    ${moment().format('DD')} ${bulan} ${moment().format('YYYY')}`,
    waktu: time
}
   ...
   switch (prefix) {
      ...
      case 'info':
       ...
       case 'nulis':
           nulis(value)
               .then(data => {
                   client.sendMessage(id, '[ESPERA PORRA...', MessageType.text)
      ...
      case 'stickergif':
            if (isMedia) {
                if (mimetype === 'video/mp4' && message.duration < 10 || mimetype === 'image/gif' && message.duration < 10) {
                    ...
                    client.reply(from, '[WAIT] Sedang di proses⏄1�71ￄ1�771ￄ1�71ￄ1�777 silahkan tunggu ± 1 min!', id)
